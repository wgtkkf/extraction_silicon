...
for n in range(-1, 2, 1): # zloop (-1 -> 0 -> +1)
    ...
    for i in range(-1, 2, 1): # xloop (-1 -> 0 -> +1)
        ...
        for j in range(-1, 2, 1): # yloop (-1 -> 0 -> +1)
            ...
            # GA2
            GA2(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA3
            GA3(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA4
            GA4(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA5
            GA5(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA6
            GA6(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA7
            GA7(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA8
            GA8(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA9
            GA9(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA10
            GA10(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA11
            GA11(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA12
            GA12(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA13
            GA13(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA14
            GA14(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA15
            GA15(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
            ...
            # GA16
            GA16(i,j,n, adjustment(s_coordinate1), adjustment(s_coordinate2)\
            ,adjustment(s_coordinate3), adjustment(s_coordinate4), adjustment(s_coordinate5)\
            ,adjustment(s_coordinate6), adjustment(s_coordinate7), adjustment(s_coordinate8)\
            ,adjustment(s_coordinate9), adjustment(s_coordinate10), adjustment(s_coordinate11)\
            ,adjustment(s_coordinate12), adjustment(s_coordinate13), adjustment(s_coordinate14)\
