...
arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16):
    ...
    if argk==-1:
        f1 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic1_K10_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f2 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic2_K10_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f3 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic3_K10_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f4 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic4_K10_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f5 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic5_K10_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f6 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic6_K10_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f7 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic7_K10_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f8 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic8_K10_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f9 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic9_K10_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f10 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic10_K10_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f11 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic11_K10_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f12 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic12_K10_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f13 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic13_K10_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f14 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic14_K10_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f15 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic15_K10_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f16 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic16_K10_"+str(argi)+str(argj)+".txt", 'w') # write mode

    elif argk==0:
        f1 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic1_K00_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f2 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic2_K00_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f3 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic3_K00_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f4 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic4_K00_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f5 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic5_K00_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f6 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic6_K00_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f7 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic7_K00_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f8 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic8_K00_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f9 =  open("../abinit/small_mat_center/general/si_4_Generic3_Generic9_K00_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f10 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic10_K00_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f11 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic11_K00_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f12 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic12_K00_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f13 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic13_K00_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f14 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic14_K00_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f15 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic15_K00_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f16 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic16_K00_"+str(argi)+str(argj)+".txt", 'w') # write mode

    elif argk==1:
        f1  = open("../abinit/small_mat_center/general/si_4_Generic3_Generic1_K01_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f2  = open("../abinit/small_mat_center/general/si_4_Generic3_Generic2_K01_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f3  = open("../abinit/small_mat_center/general/si_4_Generic3_Generic3_K01_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f4  = open("../abinit/small_mat_center/general/si_4_Generic3_Generic4_K01_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f5  = open("../abinit/small_mat_center/general/si_4_Generic3_Generic5_K01_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f6  = open("../abinit/small_mat_center/general/si_4_Generic3_Generic6_K01_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f7  = open("../abinit/small_mat_center/general/si_4_Generic3_Generic7_K01_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f8  = open("../abinit/small_mat_center/general/si_4_Generic3_Generic8_K01_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f9  = open("../abinit/small_mat_center/general/si_4_Generic3_Generic9_K01_"+str(argi)+str(argj)+".txt", 'w')  # write mode
        f10 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic10_K01_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f11 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic11_K01_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f12 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic12_K01_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f13 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic13_K01_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f14 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic14_K01_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f15 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic15_K01_"+str(argi)+str(argj)+".txt", 'w') # write mode
        f16 = open("../abinit/small_mat_center/general/si_4_Generic3_Generic16_K01_"+str(argi)+str(argj)+".txt", 'w') # write mode

    else:
        print(str('error'))

    # open
    f0 = open('si_4c_general_3.txt', 'r') # read mode
    # lines
