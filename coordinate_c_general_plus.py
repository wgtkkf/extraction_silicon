...
#lcsi = 5.430*ucangs           # [m], don't change
...
for n in range(-1, 2, 1): # zloop (-1 -> 0 -> +1)
    # z direction
    s_coordinate1[2] = coordinate1[2] + (2*n)*lcsi_bohr
    s_coordinate2[2] = coordinate2[2] + (2*n)*lcsi_bohr
    s_coordinate3[2] = coordinate3[2] + (2*n)*lcsi_bohr
    s_coordinate4[2] = coordinate4[2] + (2*n)*lcsi_bohr
    s_coordinate5[2] = coordinate5[2] + (2*n)*lcsi_bohr
    s_coordinate6[2] = coordinate6[2] + (2*n)*lcsi_bohr
    s_coordinate7[2] = coordinate7[2] + (2*n)*lcsi_bohr
    s_coordinate8[2] = coordinate8[2] + (2*n)*lcsi_bohr
    s_coordinate9[2] = coordinate9[2] + (2*n)*lcsi_bohr
    s_coordinate10[2] = coordinate10[2] + (2*n)*lcsi_bohr
    s_coordinate11[2] = coordinate11[2] + (2*n)*lcsi_bohr
    s_coordinate12[2] = coordinate12[2] + (2*n)*lcsi_bohr
    s_coordinate13[2] = coordinate13[2] + (2*n)*lcsi_bohr
    s_coordinate14[2] = coordinate14[2] + (2*n)*lcsi_bohr
    s_coordinate15[2] = coordinate15[2] + (2*n)*lcsi_bohr
    s_coordinate16[2] = coordinate16[2] + (2*n)*lcsi_bohr
